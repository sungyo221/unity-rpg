...
namespace InfinityPBR
{
    public abstract class InfinityEditor : Editor
    {
        ...
        */
        ...
        public static void Header1(string label, string toolTip, bool richText = false) => LabelBig(label, toolTip, 24, true, richText);
        ...
        public static void Header2(string label, string toolTip, bool richText = false) => LabelBig(label, toolTip, 18, true, richText);
        ...
        public static void Header3(string label, string toolTip, bool richText = false) => LabelBig(label, toolTip, 14, true, richText);
        ...
        public static void LabelBig(string label, string tooltip, int fontSize = 18, bool bold = false, bool richText = false)
        {
            GUIStyle style = new GUIStyle(bold ? EditorStyles.boldLabel : EditorStyles.label);
            style.fontSize = fontSize;
            if (richText) style.richText = true;
...
// FloatSlider with both label and tooltip
        ...
        */
        ...
        public static void StartVertical(int width, int height) => EditorGUILayout.BeginVertical(GUILayout.Width(width), GUILayout.Height(height));
        public static void StartVerticalHeight(int height) => EditorGUILayout.BeginVertical(GUILayout.Height(height));
